# 🏗️ Arquitetura SpectraAI - Diagrama de Fluxo
...
flowchart TD
    subgraph F1["📥 FASE 1 - AQUISIÇÃO DE DADOS"]
        A1["🛰️ NASA EarthData"] --> EA["tiles/earthaccess_utils.py"]
        A2["📁 Dropbox"] --> DB["dropbox_utils/downloadBaseDados.py"]
    end

    subgraph F2["⚙️ FASE 2 - CONFIGURAÇÃO"]
    ...
    subgraph F4["✂️ FASE 4 - PREPROCESSAMENTO"]
